...
| timestamp    | source IP (anonymized) | source port | domain/URL         | class | type | BIND9 label | resolver IP |resolver port	|	Ans.	|Dvs.|Str.| Fth. |Label (bot/not) |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| 00:00:00.506 | aca | 4680 | cookie.pirate | IN | A | +T | (v4) | 53 | 8 | 2 | 394 | 187 | bot |
| 00:00:00.654 | d36 | 35314 | graph.facebook.com | IN | A | +E(0)TD | (v6-2) | 853 | 2 | 514 | 27 | 57 | notbot |
